        ...
        <div className='bg-componentBackground rounded-lg p-8 shadow-lg space-y-8'>
          ...
          <section>
            ...
            <p className='text-foreground leading-relaxed'>
              ...
              personal information when you use our marketplace platform. We are
              committed to protecting your privacy and complying with applicable
              data protection laws, including the Protection of Personal
              Information Act (POPIA) and the General Data Protection Regulation
              (GDPR).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className='list-disc list-inside space-y-2 text-foreground mb-6'>
              ...
              <li>
                <strong>Identity Verification:</strong> ID photos, driver&apos;s
                license, proof of address
              </li>
              <li>
                <strong>Listing Information:</strong> Item descriptions, photos,
                prices, locations (personal or business-owned)
              </li>
              <li>
            ...
            <ul className='list-disc list-inside space-y-2 text-foreground mb-6'>
              ...
              <li>
                <strong>Business Listings:</strong> Items owned and sold by the
                business, including creation timestamp and creator information
              </li>
              <li>
          ...
          <section>
            ...
            <ul className='list-disc list-inside space-y-2 text-foreground'>
              <li>
                <strong>With Other Users:</strong> Basic profile information and
                listing details are visible to other users
              </li>
              <li>
                <strong>With Business Team Members:</strong> If you are part of
                a business account, other team members with appropriate
              ...
              <li>
                ...
                <ul className='list-disc list-inside ml-6 mt-2'>
                  ...
                  <li>
                    Assist with the investigation of suspected fraud or illegal
                    activity,
                  </li>
                  <li>
                    Protect the rights, safety, or property of our users or the
                    public.
                  </li>
                </ul>
              </li>
            ...
            <p className='text-foreground leading-relaxed mt-4'>
              <strong>
                ...
                basis, except as necessary for business account team members to
                perform their roles.
              </strong>
            </p>
          </section>
          ...
          <section>
            ...
            <p className='text-foreground leading-relaxed mb-4'>
              ...
              and do not mediate or resolve disputes, but we will cooperate with
