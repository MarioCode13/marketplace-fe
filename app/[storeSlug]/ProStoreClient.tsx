...
interface ProStoreClientProps {
  business: NonNullable<GetBusinessBySlugQuery['getBusinessBySlug']>
}

export default function ProStoreClient({ business }: ProStoreClientProps) {
  ...
  // Prefetch heavy routes when the user is a store owner
  const router = useRouter()
  useEffect(() => {
    if (isStoreUser) {
      router.prefetch('/business/edit')
