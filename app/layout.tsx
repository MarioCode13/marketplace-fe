...
export const metadata: Metadata = {
  ...
  description: 'Buy and sell secondhand items safely on Dealio, South Africa\'s trusted marketplace. Secure transactions, verified sellers, and a transparent trust rating system.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Dealio - South Africa\'s Trusted Secondhand Marketplace',
    description: 'Buy and sell secondhand items safely on Dealio, South Africa\'s trusted marketplace.',
    images: ['/og-image.jpg'],
    creator: '@dealio_za',
  },
  robots: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://dealio.org.za/listings?searchTerm={search_term_string}",
